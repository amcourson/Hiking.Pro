  ...
  return (
    <div>
      {state.currentUser.completedHikes.length ? (
        <h4 className="text-center">Congrats {state.currentUser.username}, you have {state.currentUser.completedHikes.length} completed Hikes!</h4>
      ) : (
        <h4 className="text-center">Oh No! {state.currentUser.username}, you have no completed hikes</h4>
